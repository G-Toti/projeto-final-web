...
export const Result = ({result} : {result:any}) => {
    const [classText, setClassText] = useState("inline-block text-ellipsis truncate text-orange-200");
    ...
    return (
        ...
        <div className="truncate flex flex-row bg-orange-900 w-[30rem] m-auto mt-3 rounded-lg text-orange-400 p-1">
            ...
            onError={(e) => {
                ...
                setClassText("inline-block text-ellipsis truncate text-orange-200 ml-14")
            }}
            />
